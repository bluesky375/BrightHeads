...
export class AuthenticationService {  
    ...
    public googleLogin(): Observable<any>{
        ...
        return Observable.fromPromise(this.googlePlus.login({'webClientId': '1:1066816015640:android:db6074349e13b9ad', 'offline': true}).then((res) => {
    ...
    public signinUser(form:any): Observable<any>{
        console.log('signinUser', form.client_id);
